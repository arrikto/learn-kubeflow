...
what has been defined in the notebook cells. Toggle `HP Tuning with Katib` to set up hyperparameter tuning.

![toggle katib job](images/toggle-katib-job.png){: style="display: block; margin: auto; width:80%"}
...
In the Kubeflow UI create a new Notebook Server and name it `arrikto101-lab-rok`.
